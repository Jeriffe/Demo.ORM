...
namespace Demo.RawSql
{
    ...
    public class DefaultDapperRawExecutor : IRawSqlExecutor
    {
        ...
        {
            conn.Execute(sql, BuilderDynamicParameters(parameters), transaction: trans, commandType: commandType);
        }
        ...
        {
            return conn.Query<T>(sql, BuilderDynamicParameters(parameters), transaction: trans, commandType: commandType);
        }
